...
export function PaymentsTab() {
  ...
  if (error) {
    return <div className="p-6 text-red-600 text-slate-900">Error loading payments: {error}</div>;
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4">
        ...
        >
          <option value="" className="text-slate-900 bg-white">All Methods</option>
          <option value="cash" className="text-slate-900 bg-white">Cash</option>
          <option value="bank_transfer" className="text-slate-900 bg-white">Bank Transfer</option>
          <option value="e_wallet" className="text-slate-900 bg-white">E-Wallet</option>
          <option value="qris" className="text-slate-900 bg-white">QRIS</option>
          <option value="virtual_account" className="text-slate-900 bg-white">Virtual Account</option>
          <option value="collector" className="text-slate-900 bg-white">Collector</option>
        </SimpleSelect>
