...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 21l1.5-4.5A8 8 0 1119.5 6.5 8 8 0 018 21z" />
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.5 16.5c2 1.5 4.5 2.5 7 1.5-1-1.5-2-2-3-1.5-1 .5-2.5 0-4-1.5s-2-3-1.5-4c.5-1-.1-2-1.5-3-1 2.5 0 5 1.5 7z" />
      </svg>
    ),
  },
  {
...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  const visibleNavItems = navItems.filter((item) => {
    ...
    return hasAnyFeature(item.requiredAnyFeatures);
  });
