...
function InvoicesTabContent() {
  ...
  useEffect(() => {
    ...
    fetchBillingSummary();
    fetchOverdueInvoices();
  }, [fetchInvoices, fetchBillingSummary, fetchOverdueInvoices, invoicePagination.page, invoicePagination.page_size]);
...
function PaymentsDetailTab() {
  ...
  useEffect(() => {
    fetchPayments();
  }, [fetchPayments, paymentPagination.page, paymentPagination.page_size, paymentFilters]);
